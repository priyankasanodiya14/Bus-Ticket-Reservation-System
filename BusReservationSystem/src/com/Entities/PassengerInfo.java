...
public class PassengerInfo {
 public int getDetails(int[] available, BufferedReader in,int ticketI[][], String ticketS[][], double ticketD[][], int z, int to) throws NumberFormatException, IOException {
	...
	int x=1;	
		...
		System.out.println("------------------------------------------");
		System.out.println("   1. Delhi      | INR700 |   "+available[1]+"   ");
		System.out.println("   2. Raipur     | INR180 |   "+available[2]+"   ");
		System.out.println("   3. Chennai    | INR350 |   "+available[3]+"   ");
		...
		double fare[] = { 0,700,180,350,200,250};
